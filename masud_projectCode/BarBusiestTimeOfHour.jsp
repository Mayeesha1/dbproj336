...
<% 
	...
	try{
		...
		ArrayList<Map<String,Integer>> list = new ArrayList();
   		...
   		//Make a query
   		String query = "" ;
   	   	query = "select count(bill_id), HOUR(CONVERT(TIME, time)) from bills where bar = '"+graphType+"' group by HOUR(CONVERT(TIME, time))";
   		...
   		while (result.next()) { 
   			map=new HashMap<String,Integer>();
   	   			map.put(result.getString("count(bill_id)"),result.getInt("HOUR(CONVERT(TIME, time))"));
        ...
        //Create the chart title according to what the user selected
            ...
            chartTitle = "Busiest time of Hour";

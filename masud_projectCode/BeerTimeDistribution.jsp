...
<% 
	...
	try{
		...
		ArrayList<Map<String,Integer>> list = new ArrayList();
   		...
   		//Make a query
   		String query = "" ;
   	   	query = "SELECT bills.day, sum(quantity) FROM transactions LEFT JOIN bills ON transactions.bill_id = bills.bill_id WHERE transactions.item = '"+graphType+"' GROUP BY day ORDER BY sum(quantity) DESC";
   		...
   		while (result.next()) { 
   			map=new HashMap<String,Integer>();
   	   			map.put(result.getString("bills.day"),result.getInt("sum(quantity)"));
        ...
        //Create the chart title according to what the user selected
          ...
          chartTitle = "Number of Beers Sold";
          legend = "amount sold";

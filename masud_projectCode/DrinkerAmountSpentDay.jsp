...
<% 
	...
	try{
		...
		ArrayList<Map<String,Integer>> list = new ArrayList();
   		...
   		//Make a query
   		String query = "" ;
   	   	query = "SELECT day, round(sum(total_price), 2) FROM bills WHERE drinker = '"+graphType+"' GROUP BY day";
   		...
   		while (result.next()) { 
   			map=new HashMap<String,Integer>();
   	   			map.put(result.getString("day"),result.getInt("round(sum(total_price), 2)"));
        ...
        //Create the chart title according to what the user selected
          ...
          chartTitle = "Amount spent per day";
          legend = "amount spent";

...
<% 
	...
	try{
		...
		ArrayList<Map<String,Integer>> list = new ArrayList();
   		...
   		//Make a query
   		String query = "" ;
   	   	query = "SELECT MONTHNAME(b.date) AS month, SUM(b.total_price) AS total_spent FROM bills b WHERE drinker = '"+graphType+"' GROUP BY month ORDER BY total_spent DESC;";
   		...
   		while (result.next()) { 
   			map=new HashMap<String,Integer>();
   	   			map.put(result.getString("month"),result.getInt("total_spent"));
        ...
        //Create the chart title according to what the user selected
          ...
          chartTitle = "Amount spent per month";
          legend = "amount spent";

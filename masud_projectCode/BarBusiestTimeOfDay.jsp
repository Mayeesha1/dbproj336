...
<% 
	...
	try{
		...
		ArrayList<Map<String,Integer>> list = new ArrayList();
   		...
   		//Make a query
   		String query = "" ;
   	   	query = "SELECT day, count(bill_id) FROM bills WHERE bar = '"+graphType+"' GROUP BY day ORDER BY count(bill_id) DESC";
        ...
        //Create the chart title according to what the user selected
            ...
            chartTitle = "Busiest time of the Day";
            legend="amount of transactions";
